...
urlpatterns = [
    ...
    path('delete_solicitudes/<int:id>',views.deleteSolicitudes, name="DeleteSolicitudes"),
    path('cancel_solicitudes/<int:id>',views.cancelSolicitudes, name="CancelSolicitudes"),
